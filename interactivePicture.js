...
Pec_Mayoris.attr({ id: 'Pec_Mayoris', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Pec Mayoris', 'selected': false, 'selected': false });
...
Rectus_Abdominis.attr({ id: 'Rectus_Abdominis', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Rectus Abdominis', 'selected': false });
...
Oblique.attr({ id: 'Oblique', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Oblique', 'selected': false });
...
Neck.attr({ id: 'Neck', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Neck', 'selected': false });
...
Deltoids_Front.attr({ id: 'Deltoids_Front', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Deltoids Front', 'selected': false });
...
Head_Front.attr({ id: 'Head_Front', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Head Front', 'selected': false });
...
Adductor_Longus.attr({ id: 'Adductor_Longus', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Adductor Longus', 'selected': false });
...
Knee_Front.attr({ id: 'Knee_Front', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Knee Front', 'selected': false });
...
Rectus_Femoris.attr({ id: 'Rectus_Femoris', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Rectus Femoris', 'selected': false });
...
Vastus_Medialis.attr({ id: 'Vastus_Medialis', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Vastus Medialis', 'selected': false });
...
Tibialis_Anterior.attr({ id: 'Tibialis_Anterior', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Tibialis Anterior', 'selected': false });
...
Shin.attr({ id: 'Shin', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Shin', 'selected': false });
...
Vastus_Lateralis.attr({ id: 'Vastus_Lateralis', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Vastus Lateralis', 'selected': false });
...
Brachioradialis.attr({ id: 'Brachioradialis', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Brachioradialis', 'selected': false });
...
Biceps_Brachii_Long_Head.attr({ id: 'Biceps_Brachii_Long_Head', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Biceps Brachii Long Head', 'selected': false });
...
Flexor_Digitorum.attr({ id: 'Flexor_Digitorum', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Flexor Digitorum', 'selected': false });
...
Biceps_Brachii_Short_Head.attr({ id: 'Biceps_Brachii_Short_Head', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Biceps Brachii Short Head', 'selected': false });
...
Head_Back.attr({ id: 'Head_Back', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Head Back', 'selected': false });
...
Trapezius.attr({ id: 'Trapezius', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Trapezius', 'selected': false });
...
Deltoids_Back.attr({ id: 'Deltoids_Back', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Deltoids Back', 'selected': false });
...
Latissimus_Dorsi.attr({ id: 'Latissimus_Dorsi', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Latissimus Dorsi', 'selected': false });
...
Triceps_Medial.attr({ id: 'Triceps_Medial', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Triceps Medial', 'selected': false });
...
Triceps_Lateral.attr({ id: 'Triceps_Lateral', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Triceps Lateral', 'selected': false });
...
Erector_Spinae.attr({ id: 'Erector_Spinae', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Erector Spinae', 'selected': false });
...
Extensor_Digitorum.attr({ id: 'Extensor_Digitorum', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Extensor Digitorum', 'selected': false });
...
Right_Flexor_Carpi.attr({ id: 'Right_Flexor_Carpi', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Flexor Carpi', 'selected': false });
...
Gluteus_Max.attr({ id: 'Gluteus_Max', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Gluteus Max', 'selected': false });
...
Semitendinous.attr({ id: 'Semitendinous', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Semitendinous', 'selected': false });
...
Biceps_Femoris.attr({ id: 'Biceps_Femoris', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Biceps Femoris', 'selected': false });
...
Adductor_Longus_Back.attr({ id: 'Adductor_Longus_Back', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Adductor Longus Back', 'selected': false });
...
Knee_Back.attr({ id: 'Knee_Back', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Knee Back', 'selected': false });
...
Gastrocnemius_Medialis.attr({ id: 'Gastrocnemius_Medialis', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Gastrocnemius Medialis', 'selected': false });
...
Gastrocnemius_Lateralis.attr({ id: 'Gastrocnemius_Lateralis', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Gastrocnemius Lateralis', 'selected': false });
...
Soleus.attr({ id: 'Soleus', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Soleus', 'selected': false });
...
Peroneus_Longus.attr({ id: 'Peroneus_Longus', title: '', 'stroke-width': '0', 'stroke-opacity': '1', 'fill': '#dddddd' }).data({ 'name': 'Peroneus Longus', 'selected': false });
...
_x36_9.attr({id: '_x36_9',title: '','stroke-width': '0','stroke-opacity': '1','fill': '#dddddd'}).data('id', '_x36_9');

muscleGroups.push('');

var _x37_0 = rsr.path("M 174,122,175,122,174,122 z");

_x37_0.attr({id: '_x37_0',title: '','stroke-width': '0','stroke-opacity': '1','fill': '#dddddd'}).data('id', '_x37_0');
...
for (var i = 0; i < muscleGroups.length; i++) {
	...
	muscleGroups[i].mouseout(function(e){
	    ...
	    if (this.selected == true) {
	        ...
	        this.node.setAttribute('fill', '#dddddd');
	    }
	...
	muscleGroups[i].mousedown(function (e) {
	    if (this.selected == true) {
	        ...
	        var index = selectedMuscles.indexOf(this.data('name'));
	        if (index >= 0) {
	        ...
	        this.selected = true;
	        selectedMuscles.push(this.data('name'));

	        console.log(selectedMuscles);
	        this.node.setAttribute('fill', 'gold');
	        document.getElementById('placeholder').innerHTML += " " + this.data('name');
	    ...
	    for (var i = 0; i < myData.length; i++) {
	        ...
	        if (myData[i].muscles.name == needle) { //YOU WERE ADDING A WAY TO MATCH THE ARRAY TO THE JSON FILE
	            // we found it
	    ...
	    function loadMyData() {
	        ...
	        myRequest.open("GET", "https://raw.githubusercontent.com/hallam24/JSON-files/master/excercises.JSON", true);
	        ...
	        myRequest.onload = function () {
	            ...
	            if (myRequest.readyState == 4 && myRequest.status == 200) {
	                ...
	                //workoutText.innerHTML = myData.data[0].name;
